...
class AddHandler(webapp2.RequestHandler):
    def get(self):
        ...
        bios = {
                    ...
                    "LC": "Lincoln Davenport Chafee (born March 26, 1953) is an American politician from Rhode Island who has served as the Mayor of Warwick (1993-1999), a U.S. Senator (1999-2007) and as the 74th Governor of Rhode Island (2011-2015).",
                    ...
                    "JK": "John Richard Kasich (born May 13, 1952) is an American politician who has served as the 69th Governor of Ohio since 2011. He is also a candidate for the Republican Party's nomination to the 2016 presidential election. Kasich served as a member of the United States House of Representitives, representing Ohio's 12th congressional district from 1983 to 2001. He was a commentator on Fox News Channel, hosting Heartland with John Kasich (2001–2007). He also worked as an investment banker, as managing director of Lehman Brothers' Colombus, Ohio office until the firm collapsed in 2008.",
        ...
        l_chafee = Candidate(name = "Lincoln Chafee", party = "Democrat", website = "http://www.ontheissues.org/Lincoln_Chafee.htm", bio = bios["LC"], intID1 = "IVpF6_qpfq4", intID2 = "9XobXVbqhZg", speID1 = "XEMwtaMSox4", speID2 = "XhM4-kjFqRI",
            abortion = False, marriage = False, aff_action = False, env_reg = False, deny_service = False, net_neutrality = False,
            corp_tax = False, prog_tax = False, health_care = False, border_sec = False, army_spend = False, isis = False)
        ...
        b_carson = Candidate(name = "Ben Carson", party = "Republican", website = "http://www.ontheissues.org/Ben_Carson.htm", bio = bios["BC"], intID1 = "iGoZkJ8T_ic", intID2 = "h1269Q6J8LA", speID1 = "HHvFh6lSJqk", speID2 = "AD2Q4tReN3k",
            abortion = False, marriage = False, aff_action = False, env_reg = False, deny_service = False, net_neutrality = False,
            corp_tax = False, prog_tax = False, health_care = False, border_sec = False, army_spend = False, isis = False)
        c_christie = Candidate(name = "Chris Christie", party = "Republican", website = "http://www.ontheissues.org/Chris_Christie.htm", bio = bios["CC"], ntID1 = "C-yGeUSNttw", intID2 = "da4T9CKfnqQ", speID1 = "uPxDnb2-aVI", speID2 = "P4-gVP78t9s",
            abortion = False, marriage = False, aff_action = False, env_reg = False, deny_service = False, net_neutrality = False,
            corp_tax = False, prog_tax = False, health_care = False, border_sec = False, army_spend = False, isis = False)
