...
class Candidate(ndb.Model):
    ...
    abortion = ndb.StingProperty(required = False)

    samesex = ndb.StingProperty(required = False)
    affa = ndb.StingProperty(required = False)
    er = ndb.StingProperty(required = False)
    rb = ndb.StingProperty(required = False)
    isp = ndb.StingProperty(required = False)
    ctr = ndb.StingProperty(required = False)
    pt = ndb.StingProperty(required = False)
    ah = ndb.StingProperty(required = False)
    bordersecurity = ndb.StingProperty(required = False)
    militaryspending = ndb.StingProperty(required = False)
    isis = ndb.StingProperty(required = False)
...
class AddHandler(webapp2.RequestHandler):
    def get(self):
        ...
        h_clinton = Candidate(name = "Hillary Clinton", party = "Democrat", website = "http://www.ontheissues.org/Hillary_Clinton.htm", intID1 = "7XOoOgsj_z8", intID2 = "cYKwU2MwI-8", speID1 = "6744Ym_5Ddg", speID2 = "Q4O8xo9EWb8",
                        abortion = False, samesex = False, affa = False, er = False, rb = False, isp = False, ctr = False, pt = False, ah = False, bordersecurity = False, militaryspending = False, isis = False)
        l_chafee = Candidate(name = "Lincoln Chafee", party = "Democrat", website = "http://www.ontheissues.org/Lincoln_Chafee.htm", intID1 = "IVpF6_qpfq4", intID2 = "9XobXVbqhZg", speID1 = "XEMwtaMSox4", speID2 = ""
                        abortion = False, samesex = False, affa = False, er = False, rb = False, isp = False, ctr = False, pt = False, ah = False, bordersecurity = False, militaryspending = False, isis = False)
        m_omalley = Candidate(name = "Martin O'Malley", party = "Democrat", website = "http://www.ontheissues.org/Martin_O%60Malley.htm", intID1 = "", intID2 = "", speID1 = "", speID2 = ""
                        abortion = False, samesex = False, affa = False, er = False, rb = False, isp = False, ctr = False, pt = False, ah = False, bordersecurity = False, militaryspending = False, isis = False)
